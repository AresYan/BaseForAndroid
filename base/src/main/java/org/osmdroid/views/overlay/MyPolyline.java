...
public class MyPolyline extends OverlayWithIW {
    private boolean mGeodesic;
    private final Paint mPaint = new Paint();
    private final MyLineDrawer mLineDrawer = new MyLineDrawer(256);
     ...
     */
    protected boolean onClickDefault(MyPolyline polyline, MapView mapView, GeoPoint eventPos) {
