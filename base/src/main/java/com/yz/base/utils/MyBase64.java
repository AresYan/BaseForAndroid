 ...
 *
 * the MyBase64 encoding can be represented by
...
public class MyBase64 {
    ...
    public final static byte[] _encode(byte[] byteData) {
        ...
        /*
         * Use the encoded data as indexes into the MyBase64 alphabet. (The MyBase64
    ...
    public final static byte[] _decode(byte[] byteData) throws IllegalArgumentException {
        ...
        /*
         * Convert from MyBase64 alphabet to encoded data (The MyBase64 alphabet is
         ...
         * filler, as per MyBase64 spec. stop before potential buffer overun on
        ...
        if (iSrcIdx < reviSrcIdx) {
             ...
             */
                ...
                throw new IllegalArgumentException("Warning: 1 input bytes left to process. This was not MyBase64 input");
            }
        }
        return byteDest;
    }
